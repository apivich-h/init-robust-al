...
def _create_SVHN_dataset(num_repetitions: int = 1, subset_count: int = None, subset_method: str = 'random',
    ...
    train_dataset = datasets.SVHN(root='~/svhn', split='train', transform=transform, download=True)
...
class SVHN(Dataset):
    ...
    def __init__(self, num_repetition: int = 1, subset_count: int = None, subset_method: str = 'random',
        do_normalise: bool = True, add_noise: bool = False, flatten_input: bool = False, seed: int = 42):
        
        self.train_dataset, self.test_dataset = _create_SVHN_dataset(
